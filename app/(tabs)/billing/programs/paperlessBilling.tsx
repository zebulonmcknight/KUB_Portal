      ...
      <View className="flex-1">
         ...
         <View className="flex-1 p-6 gap-6">
            ...
            <Text className="text-text_main font-sans text-xl tracking-wide leading-8">
               No more hunting for your paper bill. Elect to receive your bill via email as soon as it's ready, instead of in the mail. Paperless Billing saves time and saves paper. It's easy for you and is good for the environment.
            </Text>

            {/* "Learn more" is tappable, "about Paperless Billing" is plain text inline */}
            <Text
               className="text-active_icon font-sans text-xl"
               onPress={() => Linking.openURL("https://www.kub.org/bills-payments/billing-options/paperless-billing/")}
            >
               Learn more{" "}
         ...
         >
            <SafeAreaView className="flex-1 bg-primary">
               ...
               <View className="flex-1 p-6 gap-6">
                  ...
                  <Text className="text-text_main font-sans text-xl tracking-wide leading-8">
                     By continuing, you authorize KUB to stop sending you monthly paper bills and start e-mailing you when your monthly bill is available on your My Account page. You agree to pay your bill (including any late fees) whether or not you receive an e-mail notice or are able to access your paperless bill. [If you can't access your bill, you may call KUB at (865) 524-2911 for your payment amount.] You are still bound by all KUB rules and regulations (which are subject to change) even if you do not receive a paper bill or e-mail notice. KUB reserves the right to secure accounts in default of payment of services rendered. Additionally, all legal, late fees, and collection expenses including, but not limited to, principal and interest become the liability of the recipient.
                  </Text>
               </View>
            </SafeAreaView>
         </Modal>
