      ...
      <View className="flex-1">
         ...
         >
            ...
            <View className="bg-section rounded-xl p-6 gap-4 mt-4">
               <Text allowFontScaling={false} className="font-sans text-text_main tracking-wide text-lg text-center leading-6">
         ...
         >
            <SafeAreaView className="flex-1 bg-primary" edges={['top', 'left', 'right']}>
               ...
               <ScrollView className="flex-1 p-6" contentContainerStyle={{ gap: 12 }}>
                  <Text allowFontScaling={false} className="text-text_main font-semibold text-2xl tracking-wide">
                     Levelized Billing Terms and Conditions
                  </Text>
                  <Text allowFontScaling={false} className="text-text_main font-bold text-xl tracking-wide">
                     Levelized Billing
                  </Text>
                  <Text allowFontScaling={false} className="font-sans text-text_main tracking-wide text-xl">
