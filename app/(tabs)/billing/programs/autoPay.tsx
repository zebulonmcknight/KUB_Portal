      ...
      <View className="flex-1">
         ...
         <View className="flex-1 p-6 gap-6">
            ...
            <Text className="text-text_main font-sans text-2xl tracking-widest leading-10">
               Payments are automatically drafted from your saved payment method on or near your bill due date each month.
            </Text>
            ...
            >
               Learn more{" "}
               <Text className="text-text_main">about AutoPay</Text>
            </Text>
