   ...
   return(
      <View className="flex-1">
         ...
         <ScrollView
            ...
            <Text className="font-semibold text-text_main tracking-wide text-3xl py-4">How to Donate</Text>
            <View className="border-b border-inactive_icon"/>
            ...
            <View>
               ...
               <View className="flex-row gap-2 ml-8">
                  ...
                  <Text className="flex-1 font-sans text-text_main tracking-wide text-base mt-1">
                     ...
                     <Text className="text-active_icon" onPress={() => Linking.openURL("https://www.kub.org/customer/payments/guest/donation/donate")}>
                        here
                     </Text>
                     .   
                  </Text>
               ...
               <View className="flex-row gap-2 ml-8">
                  <Text className="text-text_main text-2xl">{'\u2022'}</Text>
                  <Text className="flex-1 font-sans text-text_main text-base tracking-wide mt-1">
               ...
               <View className="flex-row gap-2 ml-8">
                  ...
                  <Text className="flex-1 font-sans text-text_main tracking-wide text-base mt-1">
                     ...
                     <Text className="text-active_icon" onPress={() => Linking.openURL("https://www.kub.org/about/community/project-help/project-help-donations/")}>
                        here
                     </Text>
                     .  
                  </Text>
            ...
            {/* Border separator */}
            <View className="border-b border-inactive_icon"/>
            <Text className="font-semibold text-text_main tracking-wide text-3xl py-4">How to Apply for Assistance</Text>
            <View className="border-b border-inactive_icon"/>
            
            <Text className="font-sans text-text_main tracking-wide text-base">
               Contact the CAC at 865-637-6700 to see if you qualify for emergency assistance through Project Help or the{' '}
               <Text className="text-active_icon" onPress={() => Linking.openURL("https://www.knoxcac.org/utility-assistance/")}>
