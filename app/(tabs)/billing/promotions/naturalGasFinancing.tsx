   ...
   return(
      <View className="flex-1 justify-center">
         ...
         >
            ...
            <Text allowFontScaling={false} className="font-bold text-text_main tracking-wide text-xl">
            ...
            <View>
               ...
               <View className="flex-row gap-2 ml-8">
                  ...
                  <View className="flex-row">
                     <Text allowFontScaling={false} className="font-sans text-text_main tracking-wide text-base mt-1">
                        Email{' '}
                     </Text>
                     <Text
