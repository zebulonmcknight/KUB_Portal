   ...
   return(
      <View className="flex-1 justify-center">
         ...
         <View className="flex-1 gap-4 p-4">
            <Text className="font-sans text-text_main tracking-wide text-lg">
            ...
            <Text className="font-sans text-active_icon tracking-wide text-lg" onPress={() => Linking.openURL("https://www.kub.org/solar-enrollment/")}>
               Subscribe Today
            </Text>
         </View>
      </View>
