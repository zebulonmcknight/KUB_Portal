            ...
            <View>
               ...
               <View className="flex-row ml-8">
                  ...
                  <Text allowFontScaling={false} className="flex-1 font-sans text-text_main tracking-wide text-base">
                     ...
                     <Text allowFontScaling={false} className="text-active_icon" onPress={() => Linking.openURL("https://www.kub.org/fiber-availability/")}>
               ...
               <View className="flex-row ml-8">
                  <Text allowFontScaling={false} className="text-text_main font-sans text-base" style={{width: 15}}>3.</Text>
                  <Text allowFontScaling={false} className="flex-1 font-sans text-text_main tracking-wide text-base">
                     ...
                     <Text allowFontScaling={false} className="text-active_icon" onPress={() => Linking.openURL("https://aspe.hhs.gov/topics/poverty-economic-mobility/poverty-guidelines")}>
                        federal poverty guidelines
                     </Text>
                  </Text>
               </View>
               <View className="flex-row ml-8">
                  <Text allowFontScaling={false} className="text-text_main font-sans text-base" style={{width: 15}}>4.</Text>
                  <Text allowFontScaling={false} className="flex-1 font-sans text-text_main tracking-wide text-base">
