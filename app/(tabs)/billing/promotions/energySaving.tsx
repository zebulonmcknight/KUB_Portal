...
export default function EnergySaving() {
   ...
   return (
      <View className="flex-1">
         ...
         >
            <Text className="font-bold text-text_main tracking-wide text-3xl">
            ...
            <Text className="font-bold text-text_main tracking-wide text-lg">Tax Credits</Text>
            ...
            <Text className="font-bold text-active_icon tracking-wide text-lg" onPress={() => Linking.openURL("https://www.energystar.gov/about/federal_tax_credits")}>
               Learn More About IRA Home Energy Tax Credits Here
            </Text>

            <View className="border-b border-inactive_icon" />
            <Text className="font-bold text-text_main tracking-wide text-lg">Home Energy Rebates (Coming Soon)</Text>
            ...
            <Text className="font-bold text-active_icon tracking-wide text-lg" onPress={() => Linking.openURL("https://eeadminprd.kub.org")}>
