   ...
   return(
      <View className="flex-1 justify-center">
         ...
         <View className="flex-1 p-4 gap-4">
            <Text className="font-sans text-text_main tracking-wide text-lg" style={{lineHeight: 20}}>
            ...
            <Text className="font-bold text-text_main tracking-wide text-lg">Workshops for adults</Text>
            <Text className="font-sans text-text_main tracking-wide text-lg" style={{lineHeight: 20}}>
            ...
            <Text className="font-bold text-text_main tracking-wide text-lg">Workshop For teens</Text>
            <Text className="font-sans text-text_main tracking-wide text-lg" style={{lineHeight: 20}}>
            ...
            <Text className="font-bold text-text_main tracking-wide text-lg">Workshops for kids</Text>
            <Text className="font-sans text-text_main tracking-wide text-lg" style={{lineHeight: 20}}>
