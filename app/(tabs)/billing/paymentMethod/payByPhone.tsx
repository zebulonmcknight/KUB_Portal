  ...
  return (
    <View className="flex-1 justify-center items-center">
      ...
      <View className="justify-start pt-4 gap-6 flex-1">
        <Text allowFontScaling={false} className="text-text_main font-sans text-2xl tracking-widest px-6 pt-4">
          KUB accepts credit and debit cards in partnership with Paymentus
        </Text>

         {/* a n/ contact n/ */}
        <Text allowFontScaling={false} className="text-text_main font-sans text-xl tracking-wide px-6 pb-4"> 
          To pay your bill by phone
        </Text>
