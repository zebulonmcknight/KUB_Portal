  ...
  return (
    <View className="flex-1 justify-center items-center">
      ...
      <View className="justify-start pt-4 flex-1 gap-6">
        <Text allowFontScaling={false} className="text-text_main font-sans text-2xl tracking-wide px-6 pt-4">
          Mail your check or money order
        </Text>
        ...
        <Text allowFontScaling={false} className="text-text_main font-bold text-xl tracking-wide px-6">
            Knoxville Utilities Board{'\n'}
            P. O. Box 59029{'\n'}
            Knoxville, TN 37950-9017{'\n'}
        </Text>
