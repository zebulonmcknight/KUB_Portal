...
return (
    <View className="flex-1 justify-center items-center">
      ...
      <View className="justify-start pt-4">
        <Text allowFontScaling={false} className="text-text_main font-sans text-2xl tracking-wide px-6 pt-4 pb-6">
          Request online account deletion.
        </Text>

         {/* a n/ contact n/ */}
        <Text allowFontScaling={false} className="text-text_main font-sans text-xl tracking-tighter px-6 pb-4"> 
      ...
      <View className="flex-1 w-full pt-10">
        ...
        <Pressable onPress={() => Linking.openURL(`tel:${8655242911}`)} className= "rounded-xl justify-center items-center py-3.5 mx-6 my-2">
          <Text allowFontScaling={false} className="text-active_icon font-bold text-lg tracking-wider px-1">
            CALL 865-524-2911
          </Text>
        </Pressable>
      </View>
